...
contract FastPayTron {
    ...
    function cashSweepAndWithdraw(
        ...
        require(!ordersOf[withdraw.orderNo]);
    ...
    function cashSweepAndMultiSend(
        ...
        require(!ordersOf[withdrawMultiSend.orderNo]);
    ...
    function multiSendFromBalance(
        ...
        TransferHelperTron.safeApprove(withdraw.token, nSender, sendAmt);
    ...
    function claimEthFee(
        ...
        TransferHelperTron.safeTransferETH(msg.sender, _amount);
    }
